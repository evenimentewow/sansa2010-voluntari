  ...
  function Step3() {
    ...
    async function submit() {
      ...
      const payload = {
        ...
        document_url: finalData.document_url || null,
        document_tip: finalData.document_tip || null,
        acord_stocare: !!finalData.acord_stocare,
        document_la: finalData.document_url ? new Date().toISOString() : null,
      }
